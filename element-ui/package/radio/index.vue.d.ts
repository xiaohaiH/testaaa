...
declare const _default: import("vue").ComponentOptions<import("vue").default, import("@vue/composition-api").ShallowUnwrapRef<{
    formItemProps: import("@vue/composition-api").ComputedRef<Partial<Readonly<import("@vue/composition-api").ExtractPropTypes<{
        ...
        readonly type: {
            readonly type: import("@vue/composition-api").PropType<"button" | "radio">;
        };
        readonly cancelable: {
    ...
    radioGroupRef: import("@vue/composition-api").Ref<ElRadioGroup | undefined>;
    ...
    customChange: (newVal: string, currentVal: string, cb: (value?: string) => void) => void;
